% bytewords-cli(SECTION) | User Commands
%
% "November 29 2022"
...
bytewords-cli - program to do something

# SYNOPSIS

**bytewords-cli** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**bytewords-cli** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **bytewords-cli** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**bytewords-cli** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    bytewords-cli. See **foo.conf**(5) for further details.
...
**bytewords-cli** provides some return codes, that can be used in scripts:
...
Nick Ochiel <nochiel@users.noreply.github.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Nick Ochiel
